...
int main()
{
	...
	cout << "Enter numerator and denominator values:";
	...
	//测试小球组
	BallGroup ballgroup1, ballgroup2("yellow", 8), ballgroup3("blue", 10);    //定义3种颜色小球

	cout << "Enter the color and number of balls for the first group:";
	cin >> ballgroup1;             //需在BallGroup中重载提取运算符

	ballgroup2.calRatio();         //重新计算其他颜色小球的占比
	ballgroup3.calRatio();

	cout << "Output data of 3 groups of balls:" << endl;
	...
	cout << "Modify the number of yellow balls" << endl;
	ballgroup2.setNum(20);

	ballgroup1.calRatio();         //重新计算其他颜色小球的占比
	ballgroup3.calRatio();

	cout << "Output modified data of 3 groups of balls:" << endl;
	cout << setw(10) << "color" << setw(10) << "num" << setw(10) << "total" << setw(10) << "ratio" << endl;
